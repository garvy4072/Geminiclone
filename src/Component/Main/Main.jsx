...
function Main() {
const {onSent,recentprompt,showresult,loading,resultdata,newchat,setinput,setlodaing,setresultdata,privous,setshowresult , input } = useContext(Context)
    ...
    <div className='main'>
        ...
        <div className="main-container">
            ...
            <div className="cards">
                ...
                <div className="card"  onClick={()=>{
                        setinput("Brainstrom team bonding activites for our work retreat")
                    }}>
                ...
                <div className="result">
                    ...
                    <img src={gemini}alt="" className={`img ${loading ? " animation" : ""}`} />
                    {!loading ?
